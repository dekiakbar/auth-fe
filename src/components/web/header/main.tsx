...
export default function Header(props:HeaderProps) {
  return (
    <>
        <Disclosure as="nav" className="bg-white/80 dark:bg-gray-900/80 shadow-md shadow-gray-600/5 md:bg-transparent dark:shadow-none">
            {({ open }) => (
                <>
                                    ...
                                    <div className="flex space-x-4">
                                        {navigation.map((item) => (
                                            <Link
                                                ...
                                                item.current ? 'bg-gray-900 text-white' : 'text-gray-600 dark:text-gray-300',
